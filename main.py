...
#ae_train.plot_learning_curve("experiments/ae20180830111133/logs.csv")
#ae_train.plot_input_output(ae_model, path="experiments/ae20180830111133/weights/model_weights59.pt")